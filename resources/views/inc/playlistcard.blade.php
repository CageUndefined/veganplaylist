<div class="card playlist-card"
    ...
    <div class="card-header text-center d-flex align-items-center justify-content-center"
         style="background-size: cover; background-position-y: 50%; background-repeat: no-repeat;padding-top: 8px;border-radius: 10px 10px 0px 0px;padding-bottom: 5px;background-image: linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.8)),url({{ $playlist->videos[0]->getThumbnailSrcAttribute() }});color: black; cursor: pointer;"
