<footer class="main-footer">
    <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav flex-column flex-sm-row mr-auto">
                <li class="nav-item">
                    <a class="nav-link text-white" href="https://veganhacktivists.org/" target="_blank">A project by the <span class="pink">Vegan Hactivists</span></a>
                </li>
				<li class="nav-item d-none d-lg-inline-block">
                    <span class="nav-link text-white">&#8226;</span>
                </li>
				<li class="nav-item d-none d-lg-inline-block">
                    <a class="nav-link text-white" href="https://www.patreon.com/veganhacktivists" target="_blank">Please consider <span class="pink">supporting our Patreon</span></a>
                </li>
				<li class="nav-item d-none d-lg-inline-block">
                    <span class="nav-link text-white">&#8226;</span>
                </li>
